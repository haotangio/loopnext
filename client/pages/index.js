      ...
      <div className='navbar-nav-scroll'>
        <ul className='navbar-nav bd-navbar-nav flex-row'>
          <li className='nav-item'>
            <a className='nav-link active' href='/'>LoopNext</a>
          </li>
        </ul>
      </div>
          ...
          <div className='col-md-6 order-md-1 text-center text-md-left pr-md-5'>
            ...
            <div className='d-flex flex-column flex-md-row lead mb-3'>
              <a
                ...
                className='btn btn-lg btn-outline-secondary mb-3 mb-md-0 mr-md-3'>Get
                started</a>
              <a
                href='/docs/4.0/getting-started/download/'
                className='btn btn-lg btn-outline-secondary'>Download</a>
            </div>
